...
app.listen(13333, async () => {
    ...
    console.log(
        ...
        response2.headers.get("Content-Range"),
    ...
    console.log(
        (await response3.text()).slice(0, 10),
        response3.headers.get("Content-Range"),
    ...
    console.log(
        (await response4.text()).slice(0, 10),
        response4.headers.get("Content-Range"),
    ...
    console.log(
        (await response5.text()).slice(0, 10),
        response5.headers.get("Content-Range"),
        response5.headers.get("Content-Length"),
        response5.status
    );
    ...
    console.log(
        (await response6.text()).slice(0, 10),
        response6.headers.get("Content-Range"),
        response6.headers.get("Content-Length"),
        response6.status
    );
    process.exit(0);
});
