...
//
// Context managers built on async_hooks (cls-hooked, OpenTelemetry's AsyncHooksContextManager)
// carry a request's context from the init of a resource to its callbacks. raw-body makes one for
// the read, so what a middleware stored before express.json() is found in the handler after it.
// The binding is skipped when nobody could see it, and a listening init hook is somebody.
