...
Fulmine.js is [Apache-2.0](../LICENSE). It carries code from [Express](../EXPRESS_LICENSE) and from the
[compression](../COMPRESSION_LICENSE) module, both MIT, and runs on
[µWebSockets.js](https://github.com/uNetworking/uWebSockets.js), Apache-2.0, which is installed
from its own repository and never redistributed here.
