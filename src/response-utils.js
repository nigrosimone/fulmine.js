...
// The lowercase of a name the header readers were handed, cached apart from the map above because
// nothing here was validated. A fresh lowercase is a string V8 has not seen as a property key, so
// looking it up on res.headers went through the runtime: 76ns against 6 for a cached one, and
